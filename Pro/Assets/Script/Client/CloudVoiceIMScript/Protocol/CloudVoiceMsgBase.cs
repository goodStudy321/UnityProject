...
using CloudVoiceIM;
public class CloudVoiceMsgBase
{

    public static CloudVoiceMsgBase GetMsg(uint CmdId, object Parser)
    {
        switch (CmdId)
        {
            ...
            case (uint)ProtocolEnum.IM_TEXT_TO_VOICE_RESP:
                return new ImTextToVoiceResp(Parser);
            default:
                return null;
        }
    }
