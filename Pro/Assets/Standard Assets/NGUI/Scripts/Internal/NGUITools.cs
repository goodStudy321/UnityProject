...
//    }
	...
	static public void SetChildLayer (this Transform t, int layer)
	{
		for (int i = 0; i < t.childCount; ++i)
		{
            ...
            int modLayer = LayerMask.NameToLayer("UIModel");
            int bgLayer = LayerMask.NameToLayer("UIModelBg");
            int nmLayer = LayerMask.NameToLayer("NoticeModel");
            int itemLayer = LayerMask.NameToLayer("ItemModel");
            if (child.gameObject.layer == modLayer || child.gameObject.layer == bgLayer || child.gameObject.layer == nmLayer || child.gameObject.layer== itemLayer) continue;
