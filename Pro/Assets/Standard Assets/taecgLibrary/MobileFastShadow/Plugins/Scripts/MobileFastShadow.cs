...
namespace taecg.tools.mobileFastShadow
{
    ...
    public class MobileFastShadow : MonoBehaviour
    {
        ...
        void Awake ()
        {
            ...
            //PJShadowMgr.Instance.FSShadow = this;
            /// LY add end ///
            ...
            if(shadowMat == null)
            {
                Debug.LogError("New mat faild : Taecg/Projector/ProjectorShadow");
            }
            /// LY add end ///
            else
            {
        ...
        private void LateUpdate ()
        {
            ...
            /// LY add begin ///
            if (FollowTarget == null || FollowTarget.activeSelf == false)
            {
                //if(InputMgr.instance.mOwner != null && InputMgr.instance.mOwner.UnitTrans != null)
                //{
                //    FollowTarget = InputMgr.instance.mOwner.UnitTrans.gameObject;
                //}
                //else
                //{
                //    return;
