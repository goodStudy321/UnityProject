...
Shader "Toony Colors Pro 2/Character/ShadowTest"
{
	Properties
	{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom fullforwardshadows addshadow nolightmap noshadow novertexlights noambient nofog noforwardadd exclude_path:deferred exclude_path:prepass
		#pragma target 2.0
