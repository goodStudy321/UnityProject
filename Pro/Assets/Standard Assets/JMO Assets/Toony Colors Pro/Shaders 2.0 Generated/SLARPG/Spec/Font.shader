...
Shader "SLARPG/Spec/Font"
{
	...
	SubShader
	{
		...
		#pragma surface surf ToonyColorsCustom noforwardadd fullforwardshadows addshadow nofog exclude_path:deferred exclude_path:prepass
		#pragma target 3.0
		...
		void surf(Input IN, inout SurfaceOutputCustom o)
		{
			...
			dissolveColor *= lerp(0, 5.0, dissolveUV);
