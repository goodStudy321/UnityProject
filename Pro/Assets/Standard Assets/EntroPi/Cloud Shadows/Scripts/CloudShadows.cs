...
namespace EntroPi
{
    ...
    public class CloudShadows : MonoBehaviour
    {
        ...
        public float CoverageMultiplier
        {
            ...
            set { m_CoverageModifier = Mathf.Clamp01(value); }
        }

        public float SoftnessMultiplier
        {
            get { return m_SoftnessModifier; }
            set { m_SoftnessModifier = Mathf.Clamp01(value); }
        }
        ...
        {
            // Calculate the opacity based on the angle between the lights direction and horizon.
            float opacity = Mathf.Clamp01((angleToHorizon - m_HorizonAngleThreshold) / m_HorizonAngleFade);
