...
namespace Slate{
	...
	abstract public class CutsceneGroup : MonoBehaviour, IDirectable {
        ...
        /// LY add begin ///
        public GameObject oriActor { get { return originalActor; } }
        /// LY add end ///
		...
		bool IDirectable.Initialize(){
            ...
            UnityEditor.PrefabAssetType prefabType = UnityEditor.PrefabUtility.GetPrefabAssetType(actor);

            if (prefabType == UnityEditor.PrefabAssetType.Regular || prefabType == UnityEditor.PrefabAssetType.Model){
