...
namespace Slate{
	...
	public class CameraShotInspector : ActionClipInspector<CameraShot> {
        ...
        /// LY add begin ///
        SerializedProperty steadyCamExtentProp;
        /// LY add end ///
		...
		void OnEnable(){
            ...
            /// LY add begin ///
            steadyCamExtentProp = serializedObject.FindProperty("steadyCamExtent");
            /// LY add end ///
		...
		public override void OnInspectorGUI(){
            ...
            /// LY add begin ///
            EditorGUILayout.PropertyField(steadyCamExtentProp);
            /// LY add end ///
