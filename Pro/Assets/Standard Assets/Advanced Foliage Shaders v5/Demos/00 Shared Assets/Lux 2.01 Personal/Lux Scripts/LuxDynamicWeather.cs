...
AccumulatedWetness += waterAcculumulation * AccumulationRateWetness + meltWater;
		...
		if(SnowParticleSystem != null) {
			SnowEmissionModule.rateOverTime = new ParticleSystem.MinMaxCurve(MaxSnowParticlesEmissionRate * SnowIntensity);	
		}
		if(RainParticleSystem != null) {
			RainEmissionModule.rateOverTime = new ParticleSystem.MinMaxCurve(MaxRainParticlesEmissionRate * RainIntensity);	
		}
	}
}
