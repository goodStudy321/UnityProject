...
-- Created by Loong on 2017-08-23 14:27:15
-- 养成技能UI,需传入参数:
-- ids:技能ID列表,GetLock:判断是否锁定方法,srcObj:方法所在对象
--==============================================================================

--需要传入以下参数
--self.ids

require("UI/Cmn/UISkillItem")

UIAdvSkill = Super:New {Name = "UIAdvSkill"}

local My = UIAdvSkill
local USI = UISkillItem
