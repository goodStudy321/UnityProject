UIDoubleExp = Super:New{Name = "UIDoubleExp"}

local My = UIDoubleExp
...
function My:Countdown()
    local info = FestivalActMgr:GetActInfo(FestivalActMgr.ExpDB)
    ...
    local isOpen = FestivalActMgr:IsOpenExpDB()
