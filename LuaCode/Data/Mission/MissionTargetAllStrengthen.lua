...
MissionTargetAllStrengthen = baseclass(MissionTarget)
local M = MissionTargetAllStrengthen
...
function M:TargetDes()
	...
	des = string.format("[00ff00]全身[-]装备强化至[%s]%s级[-](%s/%s)", "%s", self.TID, num, self.LNum) 
	return des
end
