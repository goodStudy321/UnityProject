...
get.orange  = function() return Color.New(1,0.64,0,1) end
get.purple  = function() return Color.New(0.627,0.125,0.941,1) end
...
Color.var = Color.New(1,1,1,1)

Color.SetVar = function(r,g,b,a) 
  local var = Color.var
  var:Set(r,g,b)
  return var
end

Color.SetVarToFactor = function(r,g,b,a)
  r = r / 255.0
  g = g / 255.0
  b = b / 255.0
  if a~=nil then a = a / 255.0 end
  local var = Color.SetVar(r,g,b,a)
  return var
end
