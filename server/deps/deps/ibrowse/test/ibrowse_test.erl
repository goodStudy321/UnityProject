...
send_reqs_1(Url, NumWorkers, NumReqsPerWorker) ->
    Start_time = time_tool:get_time_tuple(),
    ...
    do_wait(Url),
    End_time = time_tool:get_time_tuple(),
...
do_send_req_1(Url, NumReqs) ->
	...
	Err ->
	    ets:insert(ibrowse_errors, {time_tool:get_time_tuple(), Err}),
...
dump_errors() ->
	...
	0 ->
	    ok;
	_ ->
	    {A, B, C} = time_tool:get_time_tuple(),
