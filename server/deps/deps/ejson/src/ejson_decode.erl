...
crap_point(C) when C =< 16#7FF ->
    <<0:5, C1:5, C2:6>> = <<C:16/integer>>,
    <<6:3/integer, C1:5, 2:2/integer, C2:6>>;
crap_point(C) when C =< 16#FFFF ->
    <<C1:4, C2:6, C3:6>> = <<C:16/integer>>,
    <<14:4/integer, C1:4, 2:2/integer, C2:6, 2:2/integer, C3:6>>;
crap_point(C) when C =< 16#1FFFFF ->
    C0 = <<C:32/integer>>,
    <<0:11, C1:3, C2:6, C3:6, C4:6>> = C0,
    <<30:5/integer, C1:3, 2:2/integer, C2:6,
            2:2/integer, C3:6, 2:2/integer, C4:6>>;
crap_point(_) ->
